...
class WikiApi
  # FIXME: nasty xor params
  def initialize(wiki: nil, site: nil)
    unless wiki.nil?
      # TODO: Remove default, make commons a real Wiki object
      wiki ||= Wiki.default_wiki
      @api_url = "#{wiki.base_url}w/api.php"
    end
    @api_url = "https://#{site}/w/api.php" unless site.nil?
  end
